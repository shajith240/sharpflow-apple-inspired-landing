    ...
    <section className="section-padding">
      <div className="container-padding">
        <ScrollReveal className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-heading text-primary mb-6">How We Work</h2>
          <p className="text-body">
            Our streamlined process ensures seamless integration of voice agents
            into your website, from initial consultation to full deployment and
            ongoing support.
          </p>
        </ScrollReveal>
        ...
        <div className="max-w-6xl mx-auto">
          <ScrollRevealContainer
            className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-2 lg:gap-6"
            staggerDelay={0.15}
          >
