    ...
    <footer className="relative overflow-hidden bg-surface-elevated border-t border-border">
      ...
      <div className="container-padding py-12 sm:py-16">
        ...
        <div className="hidden lg:grid lg:grid-cols-4 gap-12">
          ...
          {/* Product */}
          <div>
            <h4 className="text-subheading text-primary mb-4 font-medium">
              Product
            </h4>
        ...
        <div className="lg:hidden space-y-6">
          ...
          <Accordion
            type="multiple"
            className="divide-y divide-border rounded-xl border border-border/60 overflow-hidden"
          >
        ...
        <div className="border-t border-border mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-6 mt-2 md:mt-0">
            ...
            <a
              href="#"
              className="text-caption text-text-tertiary hover:text-primary transition-colors"
            >
              Privacy
            </a>
            <a
