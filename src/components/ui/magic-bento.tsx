...
export interface BentoCardProps {
  ...
  number?: number; // Added number prop for identification
}
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 p-3 w-full max-w-7xl mx-auto select-none relative"
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px hsl(var(--accent) / 0.2), 0 0 30px hsl(var(--accent) / 0.3);
          }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[280px] w-full max-w-full p-6 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out ${enableBorderGlow ? "card--border-glow" : ""
              }`;
              ...
              return (
                ...
                >
                  ...
                  <div className="card__header flex justify-between gap-3 relative">
                    <span className="card__label text-lg text-muted-foreground">{card.label}</span>
                  </div>
